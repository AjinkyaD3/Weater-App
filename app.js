...
// (function () {
//     const apiKey = "362b38db39834d17b9e61708233112";
...
//         locationInfo.innerHTML = `Location: ${data.location.name}`;
//         weatherInfo.innerHTML = `Weather: ${data.current.condition.text}`;
//         weatherIcon.src = data.current.condition.icon;
//         tempCelsius.innerHTML = `Temp in C: ${data.current.temp_c}`;
//         tempFahrenheit.innerHTML = `Temp in F: ${data.current.temp_f}`;
//         localTime.innerHTML = `Date: ${data.location.localtime}`;
...
//       locationInfo.innerHTML = "Error fetching data";
//       weatherInfo.innerHTML = "";
//       weatherIcon.src = "path/to/error-image.png";
//       tempCelsius.innerHTML = "Error";
//       tempFahrenheit.innerHTML = "Error";
//       localTime.innerHTML = "Error";
//     }
